...
def sourceChannel(path, recordName, objId, obj, aid=None):
    ...
    :param recordName: SFDC object record name
    :param objId: SFDC object id
...
def drop_unneedColumns(dataframe, obj, ac=acceptedColumns, create=True):
    ...
    :param dataframe: list dataframe
...
def clean_phoneNumber(pn):
    '''
    re-formats the original phone number to the SFDC accepted format

    :param pn: phone number value
